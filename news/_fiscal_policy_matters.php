<!DOCTYPE html>
    ...
    <head>
        ...
        <title> Fiscal Policy Matters</title>
        <style>
            header {
                background: linear-gradient(180deg, rgba(0, 0, 0, 0.6) 0%, rgb(0, 0, 0) 85%, rgb(0, 0, 0) 100%), url(../news/assets/images/blog-image_18.jpg);
