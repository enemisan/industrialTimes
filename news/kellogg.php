<!DOCTYPE html>
            ...
            <head>
                ...
                <style>
                    header {
                        background: linear-gradient(180deg, rgba(0, 0, 0, 0.6) 0%, rgb(0, 0, 0) 85%, rgb(0, 0, 0) 100%), url(../news/assets/images/64868f4869bfb.jpg);
            ...
            <body>
                ...
                <section class="post-ctn">
                    <p class="post">In Picture: Mr. Shola Olayinka, a Marketing Executive, engages the pupils and students of Moral Crown School , Badore, Ajah, Lagos; on the nourshing benefits of  GO GRAINS Cereal, a product of Kellogg Tolaram Nigeria Limited.<br />
<br />
Photo:  Industrial Times / May 12, 2023</p>
