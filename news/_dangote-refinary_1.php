<!DOCTYPE html>
    ...
    <head>
        ...
        <style>
            header {
                background: linear-gradient(180deg, rgba(0, 0, 0, 0.6) 0%, rgb(0, 0, 0) 85%, rgb(0, 0, 0) 100%), url(../news/assets/images/blog-image_41.jpg);
    ...
    <body>
        ...
        <section class="post-ctn">
            <p class="post">The completion of Nigeria&#039;s first privately owned petroleum refinery is great news to the country, and by extension, the African continent, especially in this era of single market economy - African Continental Free Trade Area Agreement (AfCFTA).</p>
