<!DOCTYPE html>
    ...
    <head>
        ...
        <style>
            header {
                background: linear-gradient(180deg, rgba(0, 0, 0, 0.6) 0%, rgb(0, 0, 0) 85%, rgb(0, 0, 0) 100%), url(../news/assets/images/blog-image_33.jpg);
    ...
    <body>
        ...
        <section class="post-ctn">
            <p class="post">Dangote: Returning Nigeria Back To Oil Exporter</p>
