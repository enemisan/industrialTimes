<!DOCTYPE html>
            ...
            <head>
                ...
                <title>Unitellas International At The BCCI in Bulgaria</title>
                <style>
                    header {
                        background: linear-gradient(180deg, rgba(0, 0, 0, 0.6) 0%, rgb(0, 0, 0) 85%, rgb(0, 0, 0) 100%), url(../news/assets/images/64868e07ef88f.jpg);
            ...
            <body>
                <header>
                    ...
                    <div class="title-author-date">
                        <h1>Unitellas International At The BCCI, LCCI MoU Signing Ceremony  in Bulgaria</h1>
                ...
                <section class="post-ctn">
                    <p class="post">Mr. Smith Osemeke, CEO , Unitellas International Limited (3rd from left last roll) , had the honor to have attended<br />
the MoU signing between the Bulgarian Chamber of Commerce and Industry and Lagos Chamber of Commerce and Industry in Sofia as one of the leading technology companies in Nigeria.<br />
<br />
Source :  Twitter</p>
