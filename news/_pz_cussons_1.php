<!DOCTYPE html>
    ...
    <head>
        ...
        <style>
            header {
                background: linear-gradient(180deg, rgba(0, 0, 0, 0.6) 0%, rgb(0, 0, 0) 85%, rgb(0, 0, 0) 100%), url(../news/assets/images/blog-image_52.jpg);
    ...
    <body>
        ...
        <section class="post-ctn">
            <p class="post">// Move the uploaded file to a desired location<br />
    $targetDirectory = &quot;../news/assets/images/&quot;; // Directory where the images should be stored<br />
    $targetFilename = basename($imageFile[&#039;name&#039;]);<br />
    $targetPath = $targetDirectory . $targetFilename;</p>
